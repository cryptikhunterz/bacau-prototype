...
- [ ] `src/velocity.py` exists with all functions
- [ ] `calculate_velocities()` returns correct velocities from position deltas
- [ ] `smooth_velocities()` applies EMA smoothing correctly
- [ ] `clamp_velocities()` limits speeds to MAX_SPEED
